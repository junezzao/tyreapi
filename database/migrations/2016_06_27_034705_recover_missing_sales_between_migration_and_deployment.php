...
class RecoverMissingSalesBetweenMigrationAndDeployment extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $sales = DB::table('sales')->whereBetween('sale_id', [38920, 39022])->get();
        ...
        $items = DB::table('sales_items')->whereBetween('item_id', [66851, 67007])->get();
        foreach ($items as $item) {
        ...
        $cart_sales  = DB::table('orders')->whereBetween('id', [38920, 39022])->where('cart_discount', '>', '0.00')->get();
