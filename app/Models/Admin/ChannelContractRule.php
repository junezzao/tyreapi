...
class ChannelContractRule extends BaseModel
{
    use SoftDeletes;
     ...
     * @var string
     */
    protected $table = 'channel_contract_rules';
    ...
    public function channel_contract()
    {
        return $this->belongsTo('App\Models\Admin\ChannelContract', 'contract_id', 'id');
    }
}
